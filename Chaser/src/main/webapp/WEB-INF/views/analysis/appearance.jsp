...
<body>
    ...
    <main id="PAGES_CONTAINER" class="PAGES_CONTAINER" tabindex="-1" data-main-content="true">
        <div class="main_content" style="width: 100%; height: 100%; display: flex; flex-wrap: wrap; padding-left: 280px; padding-right: 180px;">
            <div class="ho">
                <fieldset class="bigex">
                    ...
                    <div class="ex5" style="padding-top: 20px;">
                        <input id="appe_gender1" type="radio" name="appe_gender" value="1">
                        <label for="r1">남자</label>
                    </div>

                    <div class="ex5">
                        <input id="appe_gender2" type="radio" name="appe_gender" value="1">
                        <label for="r1">여자</label>
                    </div>

                    <div class="ex5">
                        <input id="appe_gender3" type="radio" name="appe_gender" value="1">
                        <label for="r1">모름</label>
                    </div>
                </fieldset>
            </div>
            ...
            <div class="ho">
                <fieldset class="bigex">
                    ...
                    <div class="ex2" style="padding-top: 20px;">
                        <input id="appe_height1" type="radio" name="appe_height" value="1">
                        <label for="appe_height1">160cm미만</label>
                    </div>

                    <div class="ex2">
                        <input id="appe_height2" type="radio" name="appe_height" value="1">
                        <label for="appe_height2">160~170cm미만</label>
                    </div>

                    <div class="ex2">
                        <input id="appe_height3" type="radio" name="appe_height" value="1">
                        <label for="appe_height3">170~180cm미만</label>
                    </div>

                    <div class="ex2">
                        <input id="appe_height4" type="radio" name="appe_height" value="1">
            ...
            <div class="ho">
                <fieldset class="bigex">
                    ...
                    <div class="ex" style="padding-top: 20px;">
                        <input id="appe_top_type1" type="radio" name="appe_top_type" value="1">
                        <label for="appe_top_type1">긴팔</label>
                    </div>

                    <div class="ex">
                        <input id="appe_top_type2" type="radio" name="appe_top_type" value="1">
                        <label for="appe_top_type2">반팔</label>
                    </div>

                    <div class="ex3">
                        <input id="appe_top_type3" type="radio" name="appe_top_type" value="1">
                        <label for="appe_top_type3">모름</label>
                    </div>

                    <div style="padding-left:35px;">
                        <input id="appe_top_color" type="color" name="appe_top_color" value="#121212"
            ...
            <div class="ho">
                <fieldset class="bigex">
                    ...
                    <div class="ex" style="padding-top: 20px;">
                        <input id="appe_bottom_type1" type="radio" name="appe_bottom_type" value="1">
                        <label for="appe_bottom_type1">긴바지</label>
                    </div>

                    <div class="ex">
                        <input id="appe_bottom_type2" type="radio" name="appe_bottom_type" value="1">
                        <label for="appe_bottom_type2">반바지</label>
                    </div>

                    <div class="ex3">
                        <input id="appe_bottom_type3" type="radio" name="appe_bottom_type" value="1">
                        <label for="appe_bottom_type3">모름</label>
                    </div>

                    <div style="padding-left:35px;">
                        <input id="appe_bottom_color" type="color" name="appe_bottom_color" value="#121212"
            ...
            <div class="ho">
                <fieldset
                    ...
                    <div class="ex4">
                        <input id="appe_stuff_type1" type="radio" name="appe_stuff_type" value="1">
                        <label for="appe_stuff_type1">휴대폰</label>
                    </div>

                    <div class="ex4">
                        <input id="appe_stuff_type2" type="radio" name="appe_stuff_type" value="1">
                        <label for="appe_stuff_type2">우산</label>
                    </div>

                    <div class="ex4">
                        <input id="appe_stuff_type3" type="radio" name="appe_stuff_type" value="1">
                        <label for="appe_stuff_type3">가방</label>
                    </div>

                    <div class="ex4">
                        <input id="appe_stuff_type4" type="radio" name="appe_stuff_type" value="1">
                        <label for="appe_stuff_type4">모름</label>
                    </div>

                    <div style="padding-left:35px;">
                        <input id="appe_stuff_color" type="color" name="appe_stuff_color" value="#121212"
                            style="width: 25px; height: 27px; background-color: transparent; border: none;">
