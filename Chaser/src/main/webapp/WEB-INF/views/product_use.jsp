					...
					<div
						...
						<div data-bs-spy="scroll" data-bs-target="#navbar-example2"
							...
							<p class="ptag">
								...
								그 위치에 맞는 CCTV영상들을 넣습니다.<br> 4. 다른 위치에서의 CCTV영상을 분석하고 싶다면 다시
								주소 찾기 버튼을 눌러 CCTV영상의 위치를 선택해 새로운 폴더를 만들어야 합니다.<br> 5. 원하는
								폴더를 다 만든 후 다음 버튼을 누르면 분석을 시작합니다.<br>
							...
							<p class="ptag">
								...
								영상이 나옵니다.<br> 2. 리스트에 나온 용의자를 한 명 씩 선택 해보면 그 용의자의 일치율과 함께 그
								용의자가 나온 시간대를 영상으로 확인 할 수 있습니다.<br> 3. 사용자는 시간대 바를 통해 그 용의자가
								나온 시간을 조절해가며 확인 할 수 있습니다.<br> 4. 리스트중에 범인을 선택 해 다음 버튼을 누르면
								선택한 범인의 동선을 확인 할 수 있는 페이지로 넘어갑니다.<br> 4. 만약 사용자가 생각한 범인이
								리스트에 없다면 다시 인상착의를 선택하거나 영상을 선택 할 수 있습니다. <br>
							</p>
							<br>
