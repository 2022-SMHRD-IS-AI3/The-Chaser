				...
				<div class="board_list_wrap">
					<div class="board_list">
						...
						<c:forEach items="${list }" var="episode">
							<div>
								...
								<div class="title">
									<a href="./episode_desc?episode_idx=${episode.episode_idx} ">${episode.episode_title }</a>
								</div>
					...
					<div class='board_page'>
						...
						<c:forEach var="num" begin="${pageMaker.startPage}"
							...
							<a class="num  ${pageMaker.cri.pageNum == num ? "
								on":""} " href="/episode/episode_list?pageNum=${num}">${num}</a>
